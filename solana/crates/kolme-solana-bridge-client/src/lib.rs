...
#[derive(BorshDeserialize, BorshSerialize, Clone, Eq, PartialEq, PartialOrd, Ord, Debug)]
...
pub enum SignedAction {
    ...
    SelfReplace {
        /// Borsh encoded [`SelfReplace`]
        rendered: Vec<u8>,
        signature: Signature,
    },
    NewSet {
        /// Borsh encoded [`ValidatorSet`]
        rendered: Vec<u8>,
...
pub struct SelfReplace {
    ...
    pub replacement: Secp256k1PubkeyCompressed,
}
...
pub struct ValidatorSet {
    ...
    pub listeners: BTreeSet<Secp256k1PubkeyCompressed>,
    pub needed_listeners: u16,
    pub approvers: BTreeSet<Secp256k1PubkeyCompressed>,
