...
pub(crate) const SECRET_KEY_HEX: &str =
    "bd9c12efb8c473746404dfd893dd06ad8e62772c341d5de9136fec808c5bed92";

pub(crate) const DUMMY_CODE_VERSION: &str = "dummy code version";

pub(crate) fn my_secret_key() -> SecretKey {
...
impl SampleKolmeApp {
    ...
    pub(crate) fn new_validator(validator: PublicKey) -> Self {
        let mut set = BTreeSet::new();
